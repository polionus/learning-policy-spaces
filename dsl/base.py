...
class IntNode(Node):
    ...
    def interpret(self, env: WorldState) -> int:
        raise Exception('Unimplemented method: interpret')


class BoolNode(Node):

    def interpret(self, env: WorldState) -> bool:
        raise Exception('Unimplemented method: interpret')
...
class While(StatementNode, OperationNode):
    ...
    def run_generator(self, env: WorldState):
